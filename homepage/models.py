...
class Post(models.Model):
    ...
    date_posted = models.DateTimeField(auto_now_add=True, auto_now=False)  # instead of hard setting the time this timezone.now takes the users timezone into consideration.
